    ...
    <div class="row">
      <div class="col-md-3">
        ...
        <ul class="list-unstyled">
          ...
          @endforeach
          <li><a class="link-footer" href="{{ url('blog') }}">{{ trans('misc.blog') }}</a></li>
          <li>
        </ul>
      </div>
      ...
      <div class="col-md-3">
        ...
        <ul class="list-unstyled">
          <li><a class="link-footer" href="{{ url('campaigns/latest') }}">{{ trans('misc.explore') }}</a></li>
          <li>
            @if (App\Models\Gallery::count() != 0)
          <li><a class="link-footer" href="{{ url('gallery') }}">{{ trans('misc.gallery') }}</a></li>
          <li>
            @endif
          <li><a class="link-footer" href="{{ url('create/campaign') }}">{{ trans('misc.create_campaign') }}</a></li>
          <li>
          <li><a class="link-footer" href="{{ url('campaigns/featured') }}">{{ trans('misc.featured_campaign') }}</a></li>
          <li>
            @guest
          <li><a class="link-footer" href="{{ url('login') }}">{{ trans('auth.login') }}</a></li>
          <li>
          <li><a class="link-footer" href="{{ url('register') }}">{{ trans('auth.sign_up') }}</a></li>
          <li>
            @else
          <li><a class="link-footer" href="{{ url('account') }}">{{ trans('users.account_settings') }}</a></li>
          <li>
